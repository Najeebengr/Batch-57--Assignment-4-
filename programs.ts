...
let value: number = 7; // You can assign any number to 'num'
...
let x: number = 10; // Assign any value to x
let y: number = 25; // Assign any value to y
let z: number = 15; // Assign any value to z
...
let fahrenheit: number = 77; // You can assign any temperature in Fahrenheit to 'fahrenheit'
...
let number: number = -5; // You can assign any number to 'number'
...
let numberValue: number = 7; // You can assign any number for which you want to print the multiplication table
